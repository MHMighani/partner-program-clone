// gets previous section and next section background-color
function SectionSeperator({ previousColor, nextColor }) {
  return (
    <svg
      width="1440"
      height="36"
    ...
    >
      <rect width="100%" height="100%" fill={previousColor}></rect>
      <path
